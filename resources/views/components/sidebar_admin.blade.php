...
<div class="flex min-h-screen">
    <div class="w-56 bg-customOrange rounded p-3 shadow-lg">
        ...
        <ul class="space-y-2 text-md">
            ...
            @php
                $isActive = request()->is('admin/users') || request()->is('admin/pakar');
            ...
            <!-- Riwayat Pengguna -->
            <li>
                <a href="{{ route('riwayatUser') }}"
                    class="flex bg-orange-200 items-center space-x-3 p-2 rounded-md font-medium shadow-md {{ Route::is('riwayatUser') ? 'bg-gray-100 text-black font-bold' : 'text-gray-700 hover:bg-gray-200' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
