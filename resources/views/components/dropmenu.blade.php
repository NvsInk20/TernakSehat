...
<div class="max-w-52 -mt-[5px]">
    <form method="GET" x-data="{ selectedPage: '{{ request()->segment(2) }}', openDropdown: false }">
        ...
        <div class="dropdown-items" x-show="openDropdown" x-transition>
            <a href="/Admin/penyakit" class="{{ request()->segment(2) === 'penyakit' ? 'active' : '' }}">Data
                Penyakit</a>
            <a href="/Admin/gejala" class="{{ request()->segment(2) === 'gejala' ? 'active' : '' }}">Data Gejala</a>
            <a href="/Admin/solusi" class="{{ request()->segment(2) === 'solusi' ? 'active' : '' }}">Data Solusi</a>
        </div>
