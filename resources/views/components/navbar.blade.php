<div class="max-w-full -mt-10">
    ...
    <!-- Logo dan Nama Brand -->
    <div class="xl:ml-12 absolute xl:-mt-6">
        <img src="/images/logo.png" alt="Logo" class="xl:w-24 xl:h-24 w-4 h-4 rounded-full mr-3 2xl:w-32 2xl:h-32">
    </div>

    <nav
        class="bg-orange-200 rounded-full px-4 py-2 w-1/3 xl:w-[80rem] 2xl:w-[50rem] 2xl:mt-20 mb-10 shadow-md mt-20 ml-24 xl:ml-28 2xl:ml-32 2xl:px-2 2xl:py-4">
        <div class="flex items-center ml-20 xl:ml-16 2xl:ml-24">
            <!-- Link Navigasi -->
