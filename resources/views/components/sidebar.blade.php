        ...
        <ul class="space-y-2 text-md">
            ...
            <li>
                <a href="{{ route('Admin.penyakit') }}"
                    class="flex bg-orange-200 items-center space-x-3 p-2 rounded-md font-medium shadow-md {{ Route::is('Admin.penyakit') ? 'bg-gray-100 text-black font-bold' : 'text-gray-700 hover:bg-gray-200' }}">
