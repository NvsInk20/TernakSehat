...
<head>
    ...
    <title>Data Riwayat Diagnosa</title>
    <!-- Alpine.js -->
    ...
    <div class="max-w-[60rem] mx-auto mb-[18%]" id="tabelGejala">
        ...
        <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3 bg-customOrange">
            <div>
                ...
                <p class="text-white font-bold">Data Riwayat DIagnosa Pengguna</p>
            </div>
            <div class="ml-3">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="border border-gray-300 px-4 py-2 text-center">
                                <a href="{{ route('riwayatDiagnosa.showRiwayat', ['kode_user' => $user->kode_user]) }}"
                                    class="text-blue-400">
                                    <button
                                        class="px-4 py-2 border border-blue-400 font-extrabold rounded-md hover:bg-blue-400 hover:text-white">Cek
                                        Riwayat</button>
                                </a>
                            </td>
                        </tr>
