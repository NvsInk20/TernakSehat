...
<body class="bg-gray-100 min-h-full flex">
    ...
    <div class="flex-1 bg-white p-6 mb-40">
        ...
        <div class="p-8 bg-gray-50 max-h-screen">
            ...
            <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 w-2/3 lg:w-3/4 md:w-3/4">
                <!-- Tampilkan Data -->
                @php
                ...
                <!-- Card User -->
                <div
                    class="flex items-center justify-between p-6 bg-orange-100 border-l-4 border-orange-500 rounded-lg shadow-md">
                    <div>
                ...
                <!-- Card Ahli Pakar -->
                <div
                    class="flex items-center justify-between p-6 bg-green-100 border-l-4 border-green-500 rounded-lg shadow-md">
                    <div>
                ...
                <!-- Card Penyakit -->
                <div
                    class="flex items-center justify-between p-6 bg-teal-100 border-l-4 border-teal-500 rounded-lg shadow-md">
                    <div>
            ...
            <div class="mt-8">
                ...
                <div class="mt-4  lg:w-3/4 md:w-1/2 sm:w-1/2">
                    <!-- Grafik Chart.js -->
