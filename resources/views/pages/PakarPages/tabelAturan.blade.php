...
<body class="bg-gray-100 min-h-full flex">
    ...
    <div class="absolute ml-[82%] mt-10 2xl:ml-[82%] 2xl:top-10">
                                ...
                                @if ($index === 0)
                                    ...
                                    <td class="px-4 py-2 border border-gray-300" rowspan="{{ $aturan->count() }}">
                                        <div class="flex justify-center">
                                            <a href="{{ route('aturanPenyakitPakar.edit', $item->kode_relasi) }}">
                                                <button
                                            ...
                                            <form id="deleteForm-{{ $item->kode_relasi }}"
                                                action="{{ route('aturanPenyakitPakar.destroy', $item->kode_relasi) }}"
