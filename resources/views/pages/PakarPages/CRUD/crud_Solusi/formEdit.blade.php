...
<body class="bg-orange-100">
    ...
    <div class="bg-white shadow-lg rounded-lg w-full my-10 max-w-lg mx-auto p-6 sm:p-10">
        ...
        <h1 class="text-3xl font-semibold text-center mb-6 text-gray-800">Edit Solui</h1>

        <!-- Form untuk Mengedit Gejala -->
        <form action="{{ route('solusi.update', ['kode_solusi' => $solusi->kode_solusi]) }}" method="POST">
            @csrf
            @method('PUT')
